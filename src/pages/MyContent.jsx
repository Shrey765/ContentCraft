                ...
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-700">
                        <tr className="hover:bg-slate-700/50">
                            <td className="p-4">The Unstoppable Rise of Renewable Energy</td>
                            <td className="p-4"><span className="bg-sky-500/20 text-sky-500 text-xs font-medium px-2 py-1 rounded-full">Blog Post</span></td>
